...
symptom_data = pd.read_csv("E:\\guru\\DocBuddy.ai-master\\Data\\symptoms_df.csv")
precautions_data = pd.read_csv("E:\\guru\\DocBuddy.ai-master\\Data\\precautions_df.csv")
workout_data = pd.read_csv("E:\\guru\\DocBuddy.ai-master\\Data\\workout_df.csv")
desc_data = pd.read_csv("E:\\guru\\DocBuddy.ai-master\\Data\\description.csv")
diets_data = pd.read_csv("E:\\guru\\DocBuddy.ai-master\\Data\\diets.csv")
medication_data = pd.read_csv("E:\\guru\\DocBuddy.ai-master\\Data\\medications.csv")
...
def get_predicted_values(patient_symptoms):
    ...
    model = pickle.load(open('E:\guru\DocBuddy.ai-master\Model\model.pkl', 'rb'))
...
def account():
    st.image("E:\\guru\\DocBuddy.ai-master\\static\\DocBuddy-Home.png")
            ...
            if login_submit:
                ...
                def auth_user():
                    try:
                        ...
                        api_key = 'AIzaSyB03IbEWOoTVqXMF6jS-hcJ0WX7SV9uWak'  
...
# ========= WORKFLOW TAB =========
    ...
    with col2:
        st.image(r"E:\guru\DocBuddy.ai-master\static\DocBuddy-WorkFlow-Tab.png")
...
# ========= Recommendations TAB =========
    ...
    with col2:
        st.image("E:/guru/DocBuddy.ai-master/static/Docbuddy-Recommendations.png")
...
# ========= Report Generation TAB =========
    ...
    with col1:
        if st.session_state.get("signedOut", False):
            ...
            st.markdown("* Then go to the Login Page and Login Yourself.")
    with col2:
        st.image(r"E:\guru\DocBuddy.ai-master\static\DocBuddy-Generate-Report.png")
...
# ========= Chat with me TAB =========
    ...
    with col1:
        if st.session_state.get("signedOut", False):
            ...
            st.markdown("* Then go to the Login Page and Login Yourself.")
    with col2:
        st.image(r"E:\guru\DocBuddy.ai-master\static\DOcBuddy-Chat-With-Me.png")
